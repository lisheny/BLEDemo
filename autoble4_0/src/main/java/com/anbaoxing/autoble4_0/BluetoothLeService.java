...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "com.anbaoxing.autoble4_0.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.anbaoxing.autoble4_0.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.anbaoxing.autoble4_0.ACTION_GATT_SERVICES_DISCOVERED";
...
//        String s = ApplicationUtils.byte2HexStr(heartRate);
    ...
    public boolean initialize() {
        ...
        // BluetoothManager.
        // 在API级别的18以上,通过BluetoothManager BluetoothAdapter得到一个参考。
    ...
    /**
     * 写指令时记得调用这个方法，设enabled为true，否者，蓝牙回调是不会返回数据的（没错，是被坑过0.0）
